 <!--row -->
                ...
                <!-- <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                <i class="fa fa-users" style="background-color:#C22020"></i>
                                <div class="bodystate">
                                    <h4 style="color:white"><?php echo $this->db->get('patient')->num_rows();?></h4>
                                    <span class="text-muted"><a href="" style="color:Black"><?php echo get_phrase('New Patient');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div> -->
                    ...
                    <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <h4 style="color:white"><?php echo $this->db->get('doctor')->num_rows();?></h4>
                                    <span class="text-muted"><a href="" style="color:Black"><?php echo get_phrase('New Doctor');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><a href="" style="color:Black"><?php echo get_phrase('New Nurse');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <h4 style="color:white"><?php echo $this->db->get('donor')->num_rows();?></h4>
                                    <span class="text-muted"><a href="" style="color:Black"><?php echo get_phrase('New Donor');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                <i class="fa fa-credit-card" style="background-color:#C22020"></i>
                                <div class="bodystate">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                <i class="fa fa-edit" style="background-color:#C22020"></i>
                                <div class="bodystate">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                <i class="fa fa-link" style="background-color:#C22020"></i>
                                <div class="bodystate">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                <i class="fa fa-heart" style="background-color:#C22020"></i>
                                <div class="bodystate">
